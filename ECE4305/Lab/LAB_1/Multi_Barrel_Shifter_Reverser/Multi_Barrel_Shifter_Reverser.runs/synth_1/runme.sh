...
HD_PWD='D:/Documents/Vivado/ECE4305/Lab/LAB_1/Multi_Barrel_Shifter_Reverser/Multi_Barrel_Shifter_Reverser.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_barrel_shifter_reverser.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_barrel_shifter_reverser.tcl
