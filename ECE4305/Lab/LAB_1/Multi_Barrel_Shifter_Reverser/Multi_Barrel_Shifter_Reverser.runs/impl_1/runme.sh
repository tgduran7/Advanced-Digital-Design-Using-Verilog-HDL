...
HD_PWD='D:/Documents/Vivado/ECE4305/Lab/LAB_1/Multi_Barrel_Shifter_Reverser/Multi_Barrel_Shifter_Reverser.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_barrel_shifter_reverser.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_barrel_shifter_reverser.tcl -notrace
