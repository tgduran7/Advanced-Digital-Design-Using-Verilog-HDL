...
HD_PWD='D:/Documents/Vivado/ECE4305/Lab/LAB_2/LAB_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log square_wave_gen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source square_wave_gen.tcl -notrace
