...
HD_PWD='D:/Documents/Vivado/ECE4305/Lab/LAB_2/LAB_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log square_wave_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source square_wave_gen.tcl
